...
class Sample:
    ...
    @staticmethod
    async def rate_plan_inst_sshfp_async(
        client: ESA20240910Client,
    ) -> esa20240910_models.PurchaseRatePlanResponseBody:
        logging.log(logging.INFO, 'Begin Call PurchaseRatePlan to create resource')
        purchase_rate_plan_request = esa20240910_models.PurchaseRatePlanRequest(
    ...
    @staticmethod
    def site_sshfp(
        rate_plan_inst_sshfp_response_body: esa20240910_models.PurchaseRatePlanResponseBody,
        client: ESA20240910Client,
        ...
        create_site_request = esa20240910_models.CreateSiteRequest(
            ...
            instance_id = rate_plan_inst_sshfp_response_body.instance_id,
            coverage = 'overseas',
            access_type = 'NS'
        )
    ...
    @staticmethod
    def record_sshfp(
        site_sshfp_response_body: esa20240910_models.CreateSiteResponseBody,
        client: ESA20240910Client,
        ...
        create_record_request = esa20240910_models.CreateRecordRequest(
            ...
            site_id = site_sshfp_response_body.site_id,
            type = 'SSHFP',
            data = data,
            ttl = 100
        )
    ...
    @staticmethod
    async def update_record_sshfp_async(
        create_record_response_body: esa20240910_models.CreateRecordResponseBody,
        client: ESA20240910Client,
    ) -> None:
        logging.log(logging.INFO, 'Begin Call UpdateRecord to update resource')
    ...
    @staticmethod
    async def destroy_record_sshfp_async(
        create_record_response_body: esa20240910_models.CreateRecordResponseBody,
        client: ESA20240910Client,
    ) -> None:
        logging.log(logging.INFO, 'Begin Call DeleteRecord to destroy resource')
    ...
    def main(
        ...
        # Init resource
        rate_plan_inst_sshfp_resp_body = Sample.rate_plan_inst_sshfp(esa_20240910client)
        site_sshfp_resp_body = Sample.site_sshfp(rate_plan_inst_sshfp_resp_body, esa_20240910client)
        record_sshfp_resp_body = Sample.record_sshfp(site_sshfp_resp_body, esa_20240910client)
        # update resource
        Sample.update_record_sshfp(record_sshfp_resp_body, esa_20240910client)
        # destroy resource
        Sample.destroy_record_sshfp(record_sshfp_resp_body, esa_20240910client)
    ...
    async def main_async(
        ...
        esa_20240910client = Sample.create_esa20240910client()
        # Init resource
        rate_plan_inst_sshfp_resp_body = await Sample.rate_plan_inst_sshfp_async(esa_20240910client)
        site_sshfp_resp_body = await Sample.site_sshfp_async(rate_plan_inst_sshfp_resp_body, esa_20240910client)
        record_sshfp_resp_body = await Sample.record_sshfp_async(site_sshfp_resp_body, esa_20240910client)
        # update resource
        await Sample.update_record_sshfp_async(record_sshfp_resp_body, esa_20240910client)
        # destroy resource
        await Sample.destroy_record_sshfp_async(record_sshfp_resp_body, esa_20240910client)
