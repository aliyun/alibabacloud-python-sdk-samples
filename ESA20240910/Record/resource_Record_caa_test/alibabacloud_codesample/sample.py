...
class Sample:
    ...
    @staticmethod
    async def rate_plan_inst_caa_async(
        client: ESA20240910Client,
    ) -> esa20240910_models.PurchaseRatePlanResponseBody:
        logging.log(logging.INFO, 'Begin Call PurchaseRatePlan to create resource')
        purchase_rate_plan_request = esa20240910_models.PurchaseRatePlanRequest(
    ...
    @staticmethod
    def site_caa(
        rate_plan_inst_caa_response_body: esa20240910_models.PurchaseRatePlanResponseBody,
        client: ESA20240910Client,
        ...
        create_site_request = esa20240910_models.CreateSiteRequest(
            ...
            instance_id = rate_plan_inst_caa_response_body.instance_id,
            coverage = 'overseas',
            access_type = 'NS'
        )
    ...
    @staticmethod
    def record(
        site_caa_response_body: esa20240910_models.CreateSiteResponseBody,
        client: ESA20240910Client,
        ...
        create_record_request = esa20240910_models.CreateRecordRequest(
            ...
            site_id = site_caa_response_body.site_id,
            type = 'CAA',
            data = data,
            ttl = 100
        )
    ...
    @staticmethod
    async def destroy_record_async(
        create_record_response_body: esa20240910_models.CreateRecordResponseBody,
        client: ESA20240910Client,
    ) -> None:
        logging.log(logging.INFO, 'Begin Call DeleteRecord to destroy resource')
    ...
    def main(
        ...
        # Init resource
        rate_plan_inst_caa_resp_body = Sample.rate_plan_inst_caa(esa_20240910client)
        site_caa_resp_body = Sample.site_caa(rate_plan_inst_caa_resp_body, esa_20240910client)
        record_resp_body = Sample.record(site_caa_resp_body, esa_20240910client)
        # update resource
        Sample.update_record(record_resp_body, esa_20240910client)
        # destroy resource
        Sample.destroy_record(record_resp_body, esa_20240910client)
    ...
    async def main_async(
        ...
        esa_20240910client = Sample.create_esa20240910client()
        # Init resource
        rate_plan_inst_caa_resp_body = await Sample.rate_plan_inst_caa_async(esa_20240910client)
        site_caa_resp_body = await Sample.site_caa_async(rate_plan_inst_caa_resp_body, esa_20240910client)
        record_resp_body = await Sample.record_async(site_caa_resp_body, esa_20240910client)
        # update resource
        await Sample.update_record_async(record_resp_body, esa_20240910client)
        # destroy resource
        await Sample.destroy_record_async(record_resp_body, esa_20240910client)
