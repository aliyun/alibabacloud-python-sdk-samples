...
class Sample:
    ...
    def record_cname(
        ...
        auth_conf = esa20240910_models.CreateRecordRequestAuthConf(
            secret_key = 'hijklmnhi**********mnhijklmn',
            version = 'v4',
            region = 'us-east-1',
            auth_type = 'private',
            access_key = 'abcdefgab*********efgabcdefg'
        )
    ...
    def update_record_cname(
        ...
        auth_conf = esa20240910_models.UpdateRecordRequestAuthConf(
            secret_key = 'secretkey0***********dcbafedcba',
            version = 'v2',
            region = 'us-gov-west-1',
            auth_type = 'private',
            access_key = 'AccessKey0**********edcbafedcba'
        )
    ...
    @staticmethod
    async def update_record_cname_async(
        create_record_response_body: esa20240910_models.CreateRecordResponseBody,
        client: ESA20240910Client,
    ) -> None:
        logging.log(logging.INFO, 'Begin Call UpdateRecord to update resource')
    ...
    @staticmethod
    async def destroy_record_cname_async(
        create_record_response_body: esa20240910_models.CreateRecordResponseBody,
        client: ESA20240910Client,
    ) -> None:
        logging.log(logging.INFO, 'Begin Call DeleteRecord to destroy resource')
    ...
    def main(
        ...
        record_cname_resp_body = Sample.record_cname(site_resp_body, esa_20240910client)
        # update resource
        Sample.update_record_cname(record_cname_resp_body, esa_20240910client)
        # destroy resource
        Sample.destroy_record_cname(record_cname_resp_body, esa_20240910client)
    ...
    async def main_async(
        ...
        record_cname_resp_body = await Sample.record_cname_async(site_resp_body, esa_20240910client)
        # update resource
        await Sample.update_record_cname_async(record_cname_resp_body, esa_20240910client)
        # destroy resource
        await Sample.destroy_record_cname_async(record_cname_resp_body, esa_20240910client)
