...
class Sample:
    ...
    @staticmethod
    async def http_basic_conf_async(
        rate_plan_inst_response_body: esa20240910_models.PurchaseRatePlanResponseBody,
        client: ESA20240910Client,
    ) -> esa20240910_models.CreateSiteResponseBody:
        logging.log(logging.INFO, 'Begin Call CreateSite to create resource')
    ...
    @staticmethod
    def https_basic_conf(
        http_basic_conf_response_body: esa20240910_models.CreateSiteResponseBody,
        client: ESA20240910Client,
        ...
        create_https_basic_configuration_request = esa20240910_models.CreateHttpsBasicConfigurationRequest(
            site_id = http_basic_conf_response_body.site_id,
    ...
    @staticmethod
    async def https_basic_conf_async(
        http_basic_conf_response_body: esa20240910_models.CreateSiteResponseBody,
        client: ESA20240910Client,
    ) -> esa20240910_models.CreateHttpsBasicConfigurationResponseBody:
        logging.log(logging.INFO, 'Begin Call CreateHttpsBasicConfiguration to create resource')
    ...
    @staticmethod
    async def update_https_basic_conf_async(
        http_basic_conf_response_body: esa20240910_models.CreateSiteResponseBody,
        create_https_basic_configuration_response_body: esa20240910_models.CreateHttpsBasicConfigurationResponseBody,
        client: ESA20240910Client,
    ) -> None:
    ...
    @staticmethod
    async def destroy_https_basic_conf_async(
        http_basic_conf_response_body: esa20240910_models.CreateSiteResponseBody,
        create_https_basic_configuration_response_body: esa20240910_models.CreateHttpsBasicConfigurationResponseBody,
        client: ESA20240910Client,
    ) -> None:
    ...
    def main(
        ...
        # Init resource
        # esource_RatePlanInstance_set_globle_test
        rate_plan_inst_resp_body = Sample.rate_plan_inst(esa_20240910client)
        # esource_HttpBasicConfiguration_set_global_test
        http_basic_conf_resp_body = Sample.http_basic_conf(rate_plan_inst_resp_body, esa_20240910client)
        https_basic_conf_resp_body = Sample.https_basic_conf(http_basic_conf_resp_body, esa_20240910client)
        # update resource
        Sample.update_https_basic_conf(http_basic_conf_resp_body, https_basic_conf_resp_body, esa_20240910client)
        # destroy resource
        Sample.destroy_https_basic_conf(http_basic_conf_resp_body, https_basic_conf_resp_body, esa_20240910client)
    ...
    async def main_async(
        ...
        # esource_HttpBasicConfiguration_set_global_test
        http_basic_conf_resp_body = await Sample.http_basic_conf_async(rate_plan_inst_resp_body, esa_20240910client)
        https_basic_conf_resp_body = await Sample.https_basic_conf_async(http_basic_conf_resp_body, esa_20240910client)
        # update resource
        await Sample.update_https_basic_conf_async(http_basic_conf_resp_body, https_basic_conf_resp_body, esa_20240910client)
        # destroy resource
        await Sample.destroy_https_basic_conf_async(http_basic_conf_resp_body, https_basic_conf_resp_body, esa_20240910client)
