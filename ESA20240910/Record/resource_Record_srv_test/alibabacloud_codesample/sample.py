...
class Sample:
    ...
    def record(
        ...
        create_record_request = esa20240910_models.CreateRecordRequest(
            record_name = '_udp._sip.gositecdn.cn',
    ...
    def main(
        ...
        record_resp_body = Sample.record(site_resp_body, esa_20240910client)
        # update resource
    ...
    async def main_async(
        ...
        record_resp_body = await Sample.record_async(site_resp_body, esa_20240910client)
        # update resource
